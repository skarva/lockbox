/* libgda-5.0.vapi generated by vapigen-0.28, do not modify. */
...
namespace Gda {
	...
	public class Connection : GLib.Object, Gda.Lockable {
		...
		[NoWrapper]
		public virtual void status_changed (Gda.ConnectionStatus status);
	...
	public interface DataHandler : GLib.Object {
		...
		public abstract unowned GLib.Value? get_sane_init_value (GLib.Type type);
	...
	[CCode (cheader_filename = "libgda/libgda.h", has_type_id = false)]
	public struct ServerProviderConnectionData {
